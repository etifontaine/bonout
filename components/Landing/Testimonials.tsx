            ...
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              ...
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                ...
                <blockquote className="text-xl font-medium mb-4">
                  “ Avec Bonout, j'ai réussi à organiser mon anniversaire avec
                  50 personnes. Avec un simple lien que j'ai partagé sur mes
                  différentes app de messagerie, par e-mail et le poster sur les
                  réseaux sociaux. “
                </blockquote>
