    ...
    <section className="sectionSize bg-secondary">
      ...
      <div className="md:grid md:grid-cols-2 md:grid-rows-2">
        <div className="flex items-start font-montserrat my-6 mr-10">
          ...
          <div>
            ...
            <p>
              ...
              date et un lieu. En quelques secondes tu pourras le partager à tout tes
              invités! Le tout sans inscription et gratuitement! Plus besoin d'avoir un compte sur chaque réseau social pour inviter tout le monde.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start font-montserrat my-6 mr-10">
          ...
          <div>
            ...
            <p>
              ...
              lien unique! Seul les personnes avec ton lien pourront trouver
              ton événement.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start font-montserrat my-6 mr-10">
          <img src="images/Heart.svg" alt="" className="h-7 mr-4" />
          <div>
            <h3 className="font-semibold text-2xl">Vie privée & respect de l'utilisateur</h3>
            <p>
              Ce sont des valeurs essentielles chez Bonout. Nous n'avons pas de trackers ou cookies
              sur le site, car il n'y en a pas besoin pour vous laisser organiser vos événements dans de bonnes conditions.
            </p>
          </div>
        </div>
