export const questions = [{
    ...
    answer: "Une fois ton évènement crée, tu vas obtenir un lien unique. Partage ton lien par messagerie ou transforme le en QRCode afin d'inviter toutes les personnes que tu veux."
},{
    title: "Comment êtes-vous rémunéré?",
    answer: "Tu peux faire des dons, et plus tard on proposera des fonctionnalitées payantes. Toujours sans tracking et en respectant votre vie privée."
},{
