                    ...
                    <div className="border-t border-gray-200">
                        <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <div className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 flex items-center">
                                ...
                                >
                                    {" "}
                                    {`Du ${new Date(event.start_at).toLocaleDateString('default', { day: 'numeric', month: "short" })} au ${new Date(event.end_at).toLocaleDateString('default', { day: 'numeric', month: "short" })}`}
                                </button>
                            </div>
                        </div>
                        <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <div className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 flex items-center">
                                <LocationMarkerIcon
                                    ...
                                    aria-hidden="true"
                                />
                                <button className="underline" onClick={() => openAddress(event)}>
                                    {event.address}
                                </button>
                            </div>
                        </div>
                        <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <div className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 flex items-center">
                                ...
                                <button className="underline" onClick={() => shareEvent(event)}>{`${window.location.host}/events/details/${event.link}`}</button>
                            </div>
                        </div>
                        <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <div className="text-sm font-medium text-gray-500">
                        ...
                        {!isOrganizer && (
                            <div className="py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 flex justify-between">
                                <button
                                    onClick={() => setResponse(BoInvitationValidResponse.NO, event)}
                                ...
                                <button
                                    onClick={() => setResponse(BoInvitationValidResponse.YES, event)}
                                ...
                                <button
                                    onClick={() => setResponse(BoInvitationValidResponse.MAYBE, event)}
                                    className={`btn border border-black ${userInvitationResponseValue ===
